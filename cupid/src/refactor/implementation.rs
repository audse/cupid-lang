...
impl Implementation {
	...
	pub fn find_function_value(&self, symbol: &SymbolNode, scope: &mut RLexicalScope) -> Option<FunctionNode> {
	...
	pub fn find_function(&self, symbol: &SymbolNode, scope: &mut RLexicalScope) -> Option<ValueNode> {
