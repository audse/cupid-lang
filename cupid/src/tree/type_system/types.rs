...
use crate::{SumType, Token, Value, Tree, Symbol, LexicalScope, SymbolFinder, ErrorHandler};
use super::builtin::*;
...
// 		vec![&BOOLEAN, &INTEGER, &DECIMAL, &STRING, &FUNCTION, &NONE, &ARRAY, &CHAR, &ERROR].contains(&self)
// 	}
...
// 					if arguments.len() > i && field.0.generic {
// 						field.0 = arguments[i].clone()
// 					}
// 					field.0.apply_arguments(&arguments);
// 				}
// 			},
// 			_ => ()
// 		}
