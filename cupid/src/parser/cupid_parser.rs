...
impl BaseParser {
    ...
    pub fn _name_space(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect_word(), false);once!(&mut node, self.expect(":"), false);once!(&mut node, self.expect(":"), false);optional!(&mut node, self._name_space(), false);
        });
        None
    }
    ...
    pub fn _items(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::expect_word), false);once!(&mut node, self.expect("]"), false);
        });
    ...
    pub fn _for_loop(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("for"), false);once!(&mut node, self._for_loop_parameters(), false);once!(&mut node, self.expect("in"), true);once!(&mut node, self._term(), false);once!(&mut node, self._block(), false);
        });
        None
    }
    ...
    pub fn _while_loop(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("while"), false);once!(&mut node, self._term(), false);once!(&mut node, self._block(), false);
        });
        None
    }
    ...
    pub fn _infinite_loop(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("loop"), false);once!(&mut node, self._block(), false);
        });
        None
    }
    ...
    pub fn _if_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("if"), true);once!(&mut node, self._term(), false);once!(&mut node, self._block(), false);repeat!(&mut node, self._else_if_block(), false);optional!(&mut node, self._else_block(), false);
        });
        None
    }
    ...
    pub fn _else_if_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("else"), true);once!(&mut node, self.expect("if"), true);once!(&mut node, self._term(), false);once!(&mut node, self._block(), false);
        });
        None
    }
    ...
    pub fn _else_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("else"), true);once!(&mut node, self._block(), false);
        });
        None
    }
    ...
    pub fn _box_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("box"), true);once!(&mut node, self._brace_block(), false);
        });
        None
    }
    ...
    pub fn _brace_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("{"), true);repeat!(&mut node, self._expression(), false);once!(&mut node, self._closing_brace(), false);
        });
        None
    }
    ...
    pub fn _arrow_block(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self._arrow(), true);once!(&mut node, self._expression(), false);
        });
        None
    }
    ...
    pub fn _assignment(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);once!(&mut node, self._equal(), false);once!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _property_assignment(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._property_access(), false);once!(&mut node, self._equal(), false);once!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _property_op_assignment(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._property_access(), false);once!(&mut node, self._operator(), false);once!(&mut node, self._equal(), false);once!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _property_access(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._atom(), false);once!(&mut node, self.expect("."), false);once!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _op_assignment(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);once!(&mut node, self._operator(), false);once!(&mut node, self._equal(), false);once!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _builtin_type_definition(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("type"), false);once!(&mut node, self.expect_word(), false);use_negative_lookahead!(self, self.tokens().index(), self.expect("="));
        });
        None
    }
    ...
    pub fn _struct_type_definition(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._type_symbol(), false);once!(&mut node, self._equal(), true);once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::_struct_member), false);once!(&mut node, self.expect("]"), true);
        });
        None
    }
    ...
    pub fn _struct_member(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._type_hint(), false);once!(&mut node, self._identifier(), false);
        });
        None
    }
    ...
    pub fn _sum_type_definition(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._type_symbol(), false);once!(&mut node, self._equal(), true);once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::_sum_member), false);once!(&mut node, self.expect("]"), true);
        });
        None
    }
    ...
    pub fn _alias_type_definition(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._type_symbol(), false);once!(&mut node, self._equal(), true);once!(&mut node, self._type_hint(), false);
        });
        None
    }
    ...
    pub fn _type_symbol(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("type"), false);optional!(&mut node, self._generics(), false);once!(&mut node, self._identifier(), false);
        });
        None
    }
    ...
    pub fn _generics(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::_generic_argument), false);once!(&mut node, self._closing_bracket(), false);
        });
        None
    }
    ...
    pub fn _generic_argument(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);use_negative_lookahead!(self, self.tokens().index(), self.expect(":"));
        });

        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);once!(&mut node, self.expect(":"), false);once!(&mut node, self._type_hint(), false);
        });
        None
    }
    ...
    pub fn _typed_declaration(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
                        once!(&mut node, self._type_hint(), false);optional!(&mut node, self.expect("mut"), false);once!(&mut node, self._identifier(), false);
                        group! ((self, false, node, pos) {
    ...
    pub fn _array_type_hint(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._array_kw(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self._type_hint(), false);once!(&mut node, self._closing_bracket(), false);
        });
        None
    }
    ...
    pub fn _map_type_hint(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._map_kw(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self._type_hint(), false);once!(&mut node, self.expect(","), false);once!(&mut node, self._type_hint(), false);once!(&mut node, self._closing_bracket(), false);
        });
        None
    }
    ...
    pub fn _function_type_hint(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._fun_kw(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self._type_hint(), false);once!(&mut node, self._closing_bracket(), false);
        });
        None
    }
    ...
    pub fn _struct_type_hint(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::_struct_member_type_hint), false);once!(&mut node, self.expect("]"), false);
        });
        None
    }
    ...
    pub fn _implement_type(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("use"), false);optional!(&mut node, self._generics(), false);once!(&mut node, self._type_hint(), false);once!(&mut node, self.expect("{"), false);repeat!(&mut node, self._typed_declaration(), false);once!(&mut node, self._closing_brace(), false);
        });
        None
    }
    ...
    pub fn _implement_trait(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("use"), false);optional!(&mut node, self._generics(), false);once!(&mut node, self._identifier(), false);once!(&mut node, self.expect("with"), false);once!(&mut node, self._type_hint(), false);optional!(&mut node, self._implement_trait_body(), false);
        });
        None
    }
    ...
    pub fn _implement_trait_body(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("{"), false);repeat!(&mut node, self._typed_declaration(), false);once!(&mut node, self._closing_brace(), false);
        });
        None
    }
    ...
    pub fn _trait_definition(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("trait"), false);once!(&mut node, self._generics(), false);once!(&mut node, self._identifier(), false);once!(&mut node, self._equal(), true);once!(&mut node, self.expect("["), true);once!(&mut node, self._list(&Self::_typed_declaration), false);once!(&mut node, self._closing_bracket(), false);
        });
        None
    }
    ...
    pub fn _equal(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("="), false);use_negative_lookahead!(self, self.tokens().index(), self.expect(">"));
        });
        None
    }
    ...
    pub fn _group(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("("), true);optional!(&mut node, self._term(), false);once!(&mut node, self._closing_paren(), false);
        });
        None
    }
    ...
    pub fn _function(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._parameters(), false);once!(&mut node, self._function_body(), false);
        });
        None
    }
    ...
    pub fn _function_body(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self._arrow(), false);once!(&mut node, self._empty(), true);
        });

        alt! ((self, true, node, pos) {
            once!(&mut node, self._arrow(), false);once!(&mut node, self._group(), false);
        });
    ...
    pub fn _parameter(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            optional!(&mut node, self.expect("mut"), false);once!(&mut node, self._self(), false);
        });
    ...
    pub fn _log(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._log_keyword(), false);once!(&mut node, self.expect("("), true);once!(&mut node, self._arguments(), false);once!(&mut node, self._closing_paren(), false);
        });
        None
    }
    ...
    pub fn _function_call(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._identifier(), false);once!(&mut node, self.expect("("), true);once!(&mut node, self._arguments(), false);once!(&mut node, self._closing_paren(), false);
        });
        None
    }
    ...
    pub fn _bracket_array(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("["), false);use_negative_lookahead!(self, self.tokens().index(), self.expect("."));optional!(&mut node, self._array(), false);use_negative_lookahead!(self, self.tokens().index(), self.expect("."));once!(&mut node, self._closing_bracket(), false);
        });
        None
    }

    pub fn _array(&mut self) -> Option<(ParseNode, bool)> {
        let (mut node, pos) = self.start_parse("array");
    ...
    pub fn _map(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("["), false);once!(&mut node, self._list(&Self::_map_entry), false);once!(&mut node, self.expect("]"), false);
        });
        None
    }
    ...
    pub fn _range_inclusive_inclusive(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("["), false);once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("."), true);once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("]"), false);
        });
        None
    }
    ...
    pub fn _range_inclusive_exclusive(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("["), false);once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("]"), false);once!(&mut node, self._range_term(), false);
        });
        None
    }
    ...
    pub fn _range_exclusive_inclusive(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("."), true);once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("]"), false);
        });
        None
    }
    ...
    pub fn _range_exclusive_exclusive(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._range_term(), false);once!(&mut node, self.expect("["), false);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect("]"), false);once!(&mut node, self._range_term(), false);
        });
        None
    }
    ...
    pub fn _no_op(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            use_negative_lookahead!(self, self.tokens().index(), self.expect("-"));once!(&mut node, self._atom(), false);use_negative_lookahead!(self, self.tokens().index(), self.expect("."));use_negative_lookahead!(self, self.tokens().index(), self._operator());use_negative_lookahead!(self, self.tokens().index(), self._keyword_operator());
        });
        None
    }
    ...
    pub fn _type_cast(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._compare_op(), false);optional!(&mut node, self._type_cast_suffix(), false);
        });
        None
    }
    ...
    pub fn _type_cast_suffix(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("as"), false);once!(&mut node, self._type_hint(), false);
        });
        None
    }
    ...
    pub fn _compare_op(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._add(), false);optional!(&mut node, self._compare_suffix(), false);
        });
        None
    }
    ...
    pub fn _compare_suffix(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self._keyword_operator(), false);once!(&mut node, self._compare_op(), false);
        });
        None
    }
    ...
    pub fn _add(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._multiply(), false);optional!(&mut node, self._add_suffix(), false);
        });
        None
    }
    ...
    pub fn _add_suffix(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("+"), false);once!(&mut node, self._add(), false);
        });
    ...
    pub fn _multiply(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._exponent(), false);optional!(&mut node, self._multiply_suffix(), false);
        });
        None
    }
    ...
    pub fn _multiply_suffix(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("*"), false);once!(&mut node, self._multiply(), false);
        });
    ...
    pub fn _exponent(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._atom(), false);optional!(&mut node, self._exponent_suffix(), false);
        });
        None
    }
    ...
    pub fn _exponent_suffix(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("^"), false);once!(&mut node, self._exponent(), false);
        });
        None
    }
    ...
    pub fn _unary_op(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("-"), false);once!(&mut node, self._atom(), false);
        });
        None
    }
    ...
    pub fn _break(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("break"), false);optional!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _return(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("return"), false);optional!(&mut node, self._term(), false);
        });
        None
    }
    ...
    pub fn _identifier(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            use_negative_lookahead!(self, self.tokens().index(), self._keyword());once!(&mut node, self.expect_word(), false);
        });
        None
    }
    ...
    pub fn _char(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("\\"), false);once!(&mut node, self.expect_letter(), false);
        });
        None
    }
    ...
    pub fn _decimal(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect_number(), false);once!(&mut node, self.expect("."), true);once!(&mut node, self.expect_number(), false);
        });
        None
    }
    ...
    pub fn _require_term(&mut self) -> Option<(ParseNode, bool)> {
        let (mut node, pos) = self.start_parse("require_term");
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect_tag("<e 'missing expression'>"), false);
        });
        None
    }
    ...
    pub fn _keyword(&mut self) -> Option<(ParseNode, bool)> {
        let (mut node, pos) = self.start_parse("keyword");

        alt! ((self, true, node, pos) {
            once!(&mut node, self._keyword_variable(), false);
        });
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self._reserved_word(), false);
        });
    ...
    pub fn _keyword_variable(&mut self) -> Option<(ParseNode, bool)> {
        let (mut node, pos) = self.start_parse("keyword_variable");
    ...
    pub fn _keyword_operator(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect(">"), false);once!(&mut node, self.expect("="), false);
        });
    ...
    pub fn _arrow(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self.expect("="), true);once!(&mut node, self.expect(">"), true);
        });
        None
    }
    ...
    pub fn _comment_delimiter(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect("*"), false);once!(&mut node, self.expect("*"), false);once!(&mut node, self.expect("*"), false);
        });
        None
    }
    ...
    pub fn _comment_content(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, true, node, pos) {
            once!(&mut node, self.expect_any(), false);use_negative_lookahead!(self, self.tokens().index(), self._comment_delimiter());
        });
        None
    }
    ...
    pub fn _comment(&mut self) -> Option<(ParseNode, bool)> {
        ...
        alt! ((self, false, node, pos) {
            once!(&mut node, self._comment_delimiter(), true);repeat!(&mut node, self._comment_content(), false);once!(&mut node, self.expect_any(), false);once!(&mut node, self._comment_delimiter(), true);
        });
        None
    }
}
