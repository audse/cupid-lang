...
impl Parser {
    ...
    pub fn _require_term(&mut self, _arg: Option<Token>) -> Option<(Node, bool)> {
        ...
        loop {
            use_item!(
                &mut node,
                self.expect_tag("<e 'missing expression'>"),
                false
            );
    ...
    pub fn _closing_paren(&mut self, _arg: Option<Token>) -> Option<(Node, bool)> {
        ...
        loop {
            use_item!(
                &mut node,
                self.expect_tag("<e 'missing closing parenthesis'>"),
                false
            );
    ...
    pub fn _closing_brace(&mut self, _arg: Option<Token>) -> Option<(Node, bool)> {
        ...
        loop {
            use_item!(
                &mut node,
                self.expect_tag("<e 'missing closing brace'>"),
                false
            );
    ...
    pub fn _closing_bracket(&mut self, _arg: Option<Token>) -> Option<(Node, bool)> {
        ...
        loop {
            use_item!(
                &mut node,
                self.expect_tag("<e 'missing closing bracket'>"),
                false
            );
